...
function Formulario({ sessao, onCancelar, onPronto }) {
  ...
  return (
    <div style={{ background: T.n100, borderTop: `2px solid ${T.n300}`, padding: "20px 16px",
          ...
          {[["realizada", "Sim, aconteceu"], ["remarcada", "Remarcado"], ["faltou", "Cliente não veio"]]
            .map(([v, r], i) => (
              <button key={v} type="button" role="radio" aria-checked={ocorrencia === v}
                ...
                style={{ flex: 1, padding: "9px 10px", fontSize: 14, fontWeight: 600, border: "none",
    ...
    <li style={{ background: T.bg, border: `2px solid ${aberta ? T.accent : T.n300}` }}>
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 16, padding: "16px" }}>
        <div style={{ minWidth: 72 }}>
          <span style={{ display: "block", fontSize: 20, fontWeight: 800, fontVariantNumeric: "tabular-nums",
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8, marginBottom: 6 }}>
            ...
            {registrada && (
              <span style={{ fontSize: 12, fontWeight: 600, textTransform: "uppercase", padding: "2px 8px",
          ...
          <p style={{ fontSize: 18, fontWeight: 800, letterSpacing: "-0.015em", margin: 0,
                      color: registrada ? T.n700 : T.text }}>
            {p.clientes.nome}
          </p>

          <p style={{ fontSize: 14, color: T.n600, margin: "6px 0 12px",
...
export default function Hoje() {
  ...
  const registrado = (sessao, resultado) => {
    setAbertaId(null);
    setAviso(resultado?.pesquisa
      ? `Sessão registrada. Pesquisa enviada para ${sessao.processos.clientes.nome}.`
      : "Registrado. Nenhuma pesquisa foi enviada.");
    carregar();
  };
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "24px 16px 48px" }}>
        ...
        {sessoes && (
          <div style={{ display: "flex", alignItems: "center", gap: 12, background: T.bg,
        ...
        {aviso && (
          <div style={{ display: "flex", gap: 12, background: T.successSoft,
                        border: `2px solid ${T.success}`, padding: "12px 16px", marginBottom: 20 }}
               role="status">
            <Check size={20} strokeWidth={2} style={{ color: T.success, flexShrink: 0 }} />
            <p style={{ fontSize: 14, margin: 0, flex: 1, color: "#12603c" }}>{aviso}</p>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0,
            ...
            {sessoes.map((s) => (
              <Linha key={s.id} sessao={s}
                ...
                onAbrir={() => { setAbertaId(s.id); setAviso(null); }}
